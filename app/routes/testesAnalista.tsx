        ...
        <div className="container mx-auto px-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link
              ...
              className="bg-[#6a7a6a] hover:opacity-90 text-white px-4 py-2 rounded-lg flex items-center"
            >
      ...
      <main className="flex-grow p-8">
        {loading ? (
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 text-center">
            <p className="text-gray-600">Nenhum teste cadastrado.</p>
            <Link
              to="/novoTesteAnalista"
              className="inline-block mt-4 text-[#8BA989] hover:underline"
            >
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 space-y-6">
            {testes.map((teste) => (
              <div key={teste.id} className="border-b border-gray-200 pb-4">
                ...
                >
                  <div>
                    <h2 className="text-[#8BA989] font-medium text-lg">{teste.produto}</h2>
                  ...
                  <span className="text-[#8BA989] text-2xl">
                ...
                {testeExpandido === teste.id && (
                  <div className="mt-4 pl-4 space-y-4">
                    <div>
                      <h3 className="font-medium text-[#8BA989]">Dados do Produto</h3>
                      <p className="text-gray-600">
                    ...
                    <div>
                      <h3 className="font-medium text-[#8BA989]">Dados do Teste</h3>
                      <p className="text-gray-600">
                    ...
                    <div>
                      <h3 className="font-medium text-[#8BA989]">Atributos Avaliados</h3>
